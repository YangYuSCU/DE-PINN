...
class OptimConfig():
    ...
    def OptimAndPredi(self,n_steps_1,n_steps_2):
        ...
        Case1_X_Pred = scipy.io.loadmat(self.data_path + 'Case1_X_Pred.mat')
        self.x_pred = Case1_X_Pred['x_pred']
        u_pred = self.model.predict(self.x_pred) 
        scipy.io.savemat(self.data_path +'Case1_U_Pred.mat', {'u_pred':u_pred})
